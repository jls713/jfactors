...
%
\begin{equation}
\Mh=M(\rh)\approx \frac{4}{G}\langle\sigma_{\rm los}^2\rangle \rh,
\label{eq:wolf}
\end{equation}
%
...
formulae of Paper I. We see that these formula overestimate the
J-factor by a factor $2$ and the D-factor by a factor $1.5$. We also
